...
static NSString * const kConsumerKey       = @"TZifG2tsepu5YHu4H1dhcA";
static NSString * const kConsumerSecret    = @"DOpcLm4f2kw9Kw7i2rJneTKtF04";
static NSString * const kToken             = @"g2A3IL6FrDFiuWyNsU-DsZIXqHkk5R1L";
static NSString * const kTokenSecret       = @"diAJ5erkcrt76J_5g3raPlcqfdY";
