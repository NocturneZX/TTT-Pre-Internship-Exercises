...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NSMutableArray *companyList = [_dataAccessObject GetCompanies];

        [[[companyList objectAtIndex:self.currentIndex]
          valueForKeyPath:@"CompanyProducts"] removeObjectAtIndex:indexPath.row];
        
        [self.selectedCompany.CompanyProducts removeObjectAtIndex:indexPath.row];
        
        //Update the company list
        [_dataAccessObject saveCompanies:companyList];
